...
#		projectiles[0].attach(_one_projectile_attachment_1.position, 0)
		...
		projectiles[1].position = _two_projectiles_attachment_2.position
...
#		projectiles[1].attach(_two_projectiles_attachment_2.position, 0)
		...
		projectiles[0].position = _three_projectiles_attachment_1.position
		projectiles[1].position = _three_projectiles_attachment_2.position
		projectiles[2].position = _three_projectiles_attachment_3.position
...
#		projectiles[3].attach(_four_projectiles_attachment_4.position, 0)
		...
		projectiles[0].position = _five_projectiles_attachment_1.position
		projectiles[1].position = _five_projectiles_attachment_2.position
		projectiles[2].position = _five_projectiles_attachment_3.position
		projectiles[3].position = _five_projectiles_attachment_4.position
		projectiles[4].position = _five_projectiles_attachment_5.position
...
#		projectiles[4].attach(_five_projectiles_attachment_5.position, 0)
		...
		projectiles[0].position = _six_projectiles_attachment_1.position
		projectiles[1].position = _six_projectiles_attachment_2.position
		projectiles[2].position = _six_projectiles_attachment_3.position
		projectiles[3].position = _six_projectiles_attachment_4.position
		projectiles[4].position = _six_projectiles_attachment_5.position
		projectiles[5].position = _six_projectiles_attachment_6.position
